...
const en: Dictionary = {
  ...
  "footer.languageNote": "UI available in major US languages.",
  ...
  "ui.disclaimer":
    "This paycheck calculator provides estimates only and is not tax advice. Actual withholdings may differ based on W-4 settings, local taxes, benefits, and employer policies. Consult a tax professional for personalized guidance.",
  "ui.home": "Home",
...
const es: Dictionary = {
  ...
  "footer.languageNote": "Interfaz disponible en los principales idiomas de EE. UU.",
...
const zh: Dictionary = {
  ...
  "footer.languageNote": "界面支持美国主要语言。",
  "ui.faq": "常见问题",
  "ui.related": "相关计算器",
...
const vi: Dictionary = {
  ...
  "footer.languageNote": "Giao diện hỗ trợ các ngôn ngữ phổ biến tại Mỹ.",
...
const tl: Dictionary = {
  ...
  "footer.languageNote": "Available ang UI sa pangunahing wika sa US.",
...
const fr: Dictionary = {
  ...
  "footer.languageNote": "Interface disponible dans les principales langues des États-Unis.",
...
const ko: Dictionary = {
  ...
  "footer.languageNote": "미국 주요 언어로 UI를 이용할 수 있습니다.",
  "ui.faq": "자주 묻는 질문",
  "ui.related": "관련 계산기",
...
const ar: Dictionary = {
  ...
  "footer.languageNote": "الواجهة متاحة بأهم لغات الولايات المتحدة.",
